...
grand_tab_raw <- read_csv("data-raw/fall-run-calibration/known-adults-2019.csv", 
                          col_names = c("watershed", "order", "1998", "1999", "2000", "2001", "2002", 
                                        "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", 
                                        "2011", "2012", "2013", "2014", "2015", "2016", "2017"), 
                          skip = 1)
imputed_grand_tab <- grand_tab_raw %>% 
...
rownames(imputed_grand_tab) <- watershed_attributes$watershed

grand_tab_observed <- grand_tab_raw %>% 
  gather(year, count, -watershed, -order) %>% 
...
rownames(grand_tab_observed) <- watershed_attributes$watershed
```

`r imputed_grand_tab` all values that were less than 100 or were missing we replaced with the average count for that watershed. If there were no data for the watershed we used the value 40. This data will be used to 
calculate the number of juveniles during the 20 year simulation.

`r grand_tab_observed` we removed all data less than 100, this was done to account for a lack of confidence for counts less than 100. This data will be used in the fitness function to measure the difference between
...
fall_run_fitness <- function(
  ...
  preds <- fall_run_model(seeds = seeds,
                          ..params = params)
