...
#' @param .proportion_pulse Coefficient for the proportion_pulse variable
...
#' @param .medium_pulse Additional coefficient for proportion_pulse variable for medium size fish
#' @param .large_pulse Additional coefficient for proportion_pulse variable for large size fish
#' @param .very_large_pulse Additional coefficient for proportion_pulse variable for very large size fish
#' @source IP-117068
#' @export
