...
#' @description A list containing all parameters needed for running the \code{\link{spring_run_model}}. Parameters with a single
...
#' \itemize{
#'   \item \code{spawning_habitat}: More details at \code{\link[DSMhabitat]{sr_spawn}}
#'   \item \code{inchannel_habitat_fry}: More details at \code{\link[DSMhabitat]{sr_fry}}
#'   \item \code{inchannel_habitat_juvenile}: More details at \code{\link[DSMhabitat]{sr_juv}}
#'   \item \code{floodplain_habitat}: More details at \code{\link[DSMhabitat]{sr_fp}}
...
#'   \item \code{month_return_proportions}: More details at \code{\link[springRunDSM]{month_return_proportions}}
...
#' \itemize{
#'   \item \code{proportion_hatchery}: More details at \code{\link[springRunDSM]{proportion_hatchery}}
#'   \item \code{prob_nest_scoured}: More details at \code{\link[DSMhabitat]{prob_nest_scoured}}
