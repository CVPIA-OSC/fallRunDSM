...
adult_stray <- function(wild, natal_flow, south_delta_watershed, cross_channel_gates_closed,
                        ...
                        .intercept = springRunDSM::params$.adult_stray_intercept,
                        .wild = springRunDSM::params$.adult_stray_wild,
                        .natal_flow = springRunDSM::params$.adult_stray_natal_flow,
                        .cross_channel_gates_closed = springRunDSM::params$.adult_stray_cross_channel_gates_closed,
                        .prop_bay_trans = springRunDSM::params$.adult_stray_prop_bay_trans,
                        .prop_delta_trans = springRunDSM::params$.adult_stray_prop_delta_trans){
...
surv_adult_enroute <- function(migratory_temp, bypass_overtopped, adult_harvest,
                               ..surv_adult_enroute_int = springRunDSM::params$..surv_adult_enroute_int,
                               .migratory_temp = springRunDSM::params$.adult_en_route_migratory_temp,
                               .bypass_overtopped = springRunDSM::params$.adult_en_route_bypass_overtopped) {
...
surv_adult_prespawn <- function(deg_day,
                                ..surv_adult_prespawn_int = springRunDSM::params$..surv_adult_prespawn_int,
                                .deg_day = springRunDSM::params$.adult_prespawn_deg_day){
