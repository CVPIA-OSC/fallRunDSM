...
#' @param prop_flow_natal Flow data:  More details at \code{\link[DSMflow]{proportion_flow_natal}}
#' @param south_delta_routed_watersheds Habitat data:  More details at \code{\link[DSMhabitat]{south_delta_routed_watersheds}}
#' @param cc_gates_days_closed Flow data:  More details at \code{\link[DSMflow]{delta_cross_channel_closed}}
#' @param gates_overtopped Flow data:  More details at \code{\link[DSMflow]{gates_overtopped}}
#' @param tisdale_bypass_watershed Habitat data: More details at \code{\link[DSMhabitat]{tisdale_bypass_watershed}}
#' @param yolo_bypass_watershed Habitat data: More details at \code{\link[DSMhabitat]{yolo_bypass_watershed}}
#' @param migratory_temperature_proportion_over_20 Temperature data: More details at \code{\link[DSMtemperature]{migratory_temperature_proportion_over_20}}
