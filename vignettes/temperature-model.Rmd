...
Within the `get_rearing_survival()` submodel of `fallRunDSM` `aveT20`, `aveT20D`, `maxT25`, and `maxT25` are calculated using logistic regression. The script bellow defines the numeric input to these regression models. 
...
delta_full_temp_data <- rbind(jersey_point, dutch_slough, georgiana_slough, potato_slough) %>%
  # na.omit() %>% #TODO check why they do not filter na out of delta but do out of full temp (gives totally different model results)
