...
params_biop_2008 <- list(
  ...
  ## Variable from load baseline data
  # DSMflow variables -----
  freeport_flows = DSMflow::freeport_flow$biop_2008_2009,
  vernalis_flows = DSMflow::vernalis_flow$biop_2008_2009,
  stockton_flows = DSMflow::stockton_flow$biop_2008_2009,
  CVP_exports = DSMflow::cvp_exports$biop_2008_2009,
  SWP_exports = DSMflow::swp_exports$biop_2008_2009,
  proportion_diverted = DSMflow::proportion_diverted$biop_2008_2009,
  total_diverted = DSMflow::total_diverted$biop_2008_2009,
  delta_proportion_diverted = DSMflow::delta_proportion_diverted$biop_2008_2009,
  delta_total_diverted = DSMflow::delta_total_diverted$biop_2008_2009,
  prop_pulse_flows = DSMflow::proportion_pulse_flows$biop_2008_2009,
  prop_flow_natal = DSMflow::proportion_flow_natal$biop_2008_2009,
  upper_sacramento_flows = DSMflow::upper_sacramento_flows$biop_2008_2009,
  delta_inflow = DSMflow::delta_inflow$biop_2008_2009,
  cc_gates_days_closed = DSMflow::delta_cross_channel_closed$biop_2008_2009["count", ],
  cc_gates_prop_days_closed = DSMflow::delta_cross_channel_closed$biop_2008_2009["proportion", ],
  proportion_flow_bypass = DSMflow::proportion_flow_bypasses$biop_2008_2009,
  gates_overtopped = DSMflow::gates_overtopped$biop_2008_2009,

  # DSMtemperature variables -----
  vernalis_temps = DSMtemperature::vernalis_temperature,
  prisoners_point_temps = DSMtemperature::prisoners_point_temperature,
  degree_days = DSMtemperature::degree_days$biop_2008_2009,
  mean_egg_temp_effect = DSMtemperature::egg_temperature_effect$fall_run,
  avg_temp = DSMtemperature::stream_temperature$biop_2008_2009,
  avg_temp_delta = DSMtemperature::delta_temperature,
  migratory_temperature_proportion_over_20 = DSMtemperature::migratory_temperature_proportion_over_20,

  # DSMhabitat variables -----
  spawning_habitat = DSMhabitat::fr_spawn$biop_2008_2009,
  inchannel_habitat_fry = DSMhabitat::fr_fry$biop_2008_2009, # vary by run
  inchannel_habitat_juvenile = DSMhabitat::fr_juv$biop_2008_2009, # vary by run
  floodplain_habitat = DSMhabitat::fr_fp$biop_2008_2009, # vary by run
  weeks_flooded = DSMhabitat::weeks_flooded$biop_2008_2009,
  delta_habitat = DSMhabitat::delta_habitat,
  sutter_habitat = DSMhabitat::sutter_habitat$biop_2008_2009,
  yolo_habitat = DSMhabitat::yolo_habitat$biop_2008_2009,
  tisdale_bypass_watershed = DSMhabitat::tisdale_bypass_watershed,
  yolo_bypass_watershed = DSMhabitat::yolo_bypass_watershed,
  south_delta_routed_watersheds = DSMhabitat::south_delta_routed_watersheds,
  prop_high_predation = DSMhabitat::prop_high_predation,
